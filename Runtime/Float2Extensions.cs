...
namespace UnityMathExtensionMethods.unity_math_extension_methods.Runtime;
...
public static class Float2Extensions
{
    ...
    public static float2 Subtract(this float2 vector, float? x = null, float? y = null) =>
        new float2(vector.x - x ?? vector.x, vector.y - y ?? vector.y);

    /// <summary>
    /// Subtract any value from x and/or y.
    /// </summary>
    public static float2 Subtract(this float2 vector, float2 subtractedVector) =>
    ...
    public static float2 Multiply(this float2 vector, float? x = null, float? y = null) =>
        new float2(vector.x * x ?? vector.x, vector.y * y ?? vector.y);
    ...
    public static float2 Divide(this float2 vector, float? x = null, float? y = null) =>
        new float2(vector.x / x ?? vector.x, vector.y / y ?? vector.y);
    ...
    {
        float2 closest = new float2(Mathf.Infinity, Mathf.Infinity);
